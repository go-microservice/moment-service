...
import (
	...
	// _ "github.com/go-eagle/eagle/docs" // docs is generated by Swag CLI, you have to import it.

	"github.com/go-eagle/eagle/pkg/app"
	"github.com/go-eagle/eagle/pkg/middleware"
	"github.com/go-microservice/moment-service/internal/handler"
)
...
func NewRouter() *gin.Engine {
	...
	// swagger api docs
	if app.Conf.Mode == gin.DebugMode || app.Conf.Mode == gin.TestMode {
