...
func (c *likeServiceClient) BatchGetLike(ctx context.Context, in *BatchGetLikeRequest, opts ...grpc.CallOption) (*BatchGetLikeReply, error) {
	...
	err := c.cc.Invoke(ctx, LikeService_BatchGetLike_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *likeServiceClient) ListPostLike(ctx context.Context, in *ListPostLikeRequest, opts ...grpc.CallOption) (*ListLikeReply, error) {
	...
	err := c.cc.Invoke(ctx, LikeService_ListPostLike_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *likeServiceClient) ListCommentLike(ctx context.Context, in *ListCommentLikeRequest, opts ...grpc.CallOption) (*ListLikeReply, error) {
	out := new(ListLikeReply)
	err := c.cc.Invoke(ctx, LikeService_ListCommentLike_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LikeService_BatchGetLike_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LikeService_BatchGetLike_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LikeService_ListPostLike_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LikeService_ListPostLike_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _LikeService_ListCommentLike_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LikeService_ListCommentLike_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
